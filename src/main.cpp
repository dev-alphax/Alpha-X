...
const string strMessageMagic = "Alphax Signed Message:\n";
    ...
    int64_t nRewardCoinYear = COIN_YEAR_REWARD; //10% reward up to end
        ...
        printf("Block Number %d \n",nBestHeight);
            ...
            if(nBestHeight < 262800)
                nRewardCoinYear = 12 * COIN_YEAR_REWARD; //120% reward for 262800 blocks
            else if(nBestHeight < (2 * 262800))
                nRewardCoinYear = 6 * COIN_YEAR_REWARD; //60% reward for 262800 * 2 blocks
            else if(nBestHeight < (3 * 262800))
                nRewardCoinYear = 3.6 * COIN_YEAR_REWARD; //36% reward for 262800 * 3 blocks
            else if(nBestHeight < (4 * 262800))
                nRewardCoinYear = 2.4 * COIN_YEAR_REWARD; //24% reward for 262800 * 4 blocks
            else if(nBestHeight < (5 * 262800))
                nRewardCoinYear = 1.2 * COIN_YEAR_REWARD; //12% reward for 262800 * 5 blocks
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Alphax", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The Times 30 August 2018";
        CTransaction txNew;
        txNew.nTime = 1535580000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1535580000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 9937138 : 9937138;
        ...
        assert(block.hashMerkleRoot == uint256("0x693abd28d5f2f9787065b410418c8955cd210dabeb77b9120524871ee33d9604"));
...
unsigned char pchMessageStart[4] = { 0x07, 0xb3, 0x56, 0xe7 };
